...
class Dictionary():
    def __init__(self):
        ...
        self.choose_position_header = {}
        self.choose_position_header_evry_two = {}
        self.spravochnik = {}
        self.choose_otdel = {}

        self.check_file = os.path.exists("C:\\Users\\Public\\property-analysis-system\\dicts.json")
        if self.check_file:
            ...
            with open ("C:\\Users\\Public\\property-analysis-system\\dicts.json", encoding='utf-8') as f:
                ...
                self.lifetime = dict(templates['lifetime'])
                self.choose_position = dict(templates['choose_position'])
                self.choose_position_header = dict(templates['choose_position_header'])
                self.choose_position_header_evry_two = dict(templates['choose_position_header_evry_two'])
                self.spravochnik = dict(templates['spravochnik'])
                self.choose_otdel = list(templates['spravochnik'])

        else:
            self.check_folder = os.path.exists("C:\\Users\\Public\\property-analysis-system\\")
            if not self.check_folder:
                os.mkdir("C:\\Users\\Public\\property-analysis-system\\")
            with open("C:\\Users\\Public\\property-analysis-system\\dicts.json", "w") as outfile:
                json.dump(
                    {
                    "lifetime" : 
                        {
                    ...
                    "choose_position" : 
                        ...
                        "choose_position_header" : {
                            ...
                            "Количество раб. станций" : "рабочая станция"
                        },
                        ...
                        "choose_position_header_evry_two" : {
                            ...
                            "Количество стелажей": "Из них стелажей с превышенным сроком",
                            ...
                            "Количество раб. станций" : "Из них рабочих станций с превышенным сроком"
                        },
